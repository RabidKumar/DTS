...
public class BIH_ST016 {

	public static void main(String[] args) throws IOException, InterruptedException, Exception {
		try {
			  WindowsUtils.killByName("firefox.exe");
			  System.out.println("Browser Closed. \n\nOpening New Browser for: \nTrack Bill Scheduler (View jobs by Status).");
		...
		Thread.sleep(2000);
		bih.findElement(By.id("statusInput")).click();
		Thread.sleep(2000);		
		//bih.findElement(By.id("status")).sendKeys("SCHEDULED");
		bih.findElement(By.id("status")).sendKeys("EXECUTED");
		//bih.findElement(By.id("status")).sendKeys("FAILED");
		//bih.findElement(By.id("status")).sendKeys("CANCELLED");
		//bih.findElement(By.id("status")).sendKeys("PAUSED");
		//bih.findElement(By.id("status")).sendKeys("RESUME");
		//bih.findElement(By.id("status")).sendKeys("UNINITIALIZED");
		//bih.findElement(By.id("status")).sendKeys("INPROGRESS");
		Thread.sleep(2000);
		bih.findElement(By.id("byStatusButton")).click();
