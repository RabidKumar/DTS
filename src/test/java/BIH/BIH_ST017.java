...
public class BIH_ST017 {

	public static void main(String[] args) throws IOException, InterruptedException, Exception {
		try {
			  WindowsUtils.killByName("firefox.exe");
			  System.out.println("Browser Closed. \n\nOpening New Browser for: \nTrack Bill Scheduler (Invoice Generation Status).");
		...
		Thread.sleep(2000);
		bih.findElement(By.cssSelector("#leftMenuContainer > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(1) > div:nth-child(3) > div:nth-child(2) > div:nth-child(3)")).click();
		Thread.sleep(2000);
		bih.findElement(By.id("billRunId")).sendKeys("BillRun_19012017_2");;
		Thread.sleep(2000);		
		bih.findElement(By.id("criteria")).sendKeys("ALL");
/*		bih.findElement(By.id("criteria")).sendKeys("ACCOUNT");
		bih.findElement(By.id("billRunId")).click();
		bih.findElement(By.id("account")).sendKeys("129261");*/
		//bih.findElement(By.id("criteria")).sendKeys("CURRENTSTATUS");
		//bih.findElement(By.id("criteria")).sendKeys("ERROR");
