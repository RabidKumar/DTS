...
public class BIH_ST020 {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		System.out.println("There are "+lastRow2+" NETS accounts for invoice posting.");
		for (int i=1;i<=lastRow2;i++) 
		{
		bih.findElement(By.cssSelector("#leftMenuContainer > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(1) > div:nth-child(4) > div:nth-child(2) > div:nth-child(1)")).click();
		...
		for (WebElement temp : OCM_id) 
			{
			System.out.println(temp.getText()+" account selected for invoice posting");
