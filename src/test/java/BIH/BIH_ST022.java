...
public class BIH_ST022 {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		Thread.sleep(2000);
		bih.findElement(By.cssSelector("#leftMenuContainer > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(1) > div:nth-child(4) > div:nth-child(2) > div:nth-child(3)")).click();
		Thread.sleep(2000);
		...
		bih.findElement(By.id("billRunId")).sendKeys("BillRun%");
		Thread.sleep(2000);
		bih.findElement(By.id("submitButton")).click();

		System.out.println("\nBill Posting for Bill Run Scheduled.");
	}
