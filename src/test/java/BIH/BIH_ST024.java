...
public class BIH_ST024 {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		try {
			  ...
			  System.out.println("Browser Closed. \n Opening New Browser for: \nReverse Bill Posting for Bill Cycle...");
		...
		Thread.sleep(2000);
		bih.findElement(By.cssSelector("#leftMenuContainer > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(1) > div:nth-child(5) > div:nth-child(2) > div:nth-child(2)")).click();
		Thread.sleep(2000);
		...
		System.out.println("\nReverse Bill Posting for Bill Cycle Scheduled.");
	}
