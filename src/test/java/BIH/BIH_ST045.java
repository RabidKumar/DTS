...
//Verify the invoice of 2 bill cycles together, when a particular bill cycle’s invoice is not generated (Skipped) for previous bill cycle.


public class BIH_ST045 {
	...
	public static void main(String[] args) throws IOException, InterruptedException, AWTException {
		...
		try {
			  ...
			  System.out.println("Browser Closed. \n Opening New Browser to verify the invoice of 2 bill cycles together...");
		...
		System.out.println("\nTo test this testcase, we need to skip invoice generation for a billCycle component & generate the invoice for next billCycle component");
	...
	Thread.sleep(2000);
		...
		System.out.println("Verify the invoice of 2 bill cycles together, when a particular bill cycle’s invoice is not generated (Skipped) for previous bill cycle.");
