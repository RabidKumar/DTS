...
//Validate that taxes to be calculate in Singapore Dollars irrespective of the Product currency.

public class BIH_ST046 {
	...
	public static void main(String[] args) throws IOException, InterruptedException, AWTException {
		...
		try {
			  ...
			  System.out.println("Browser Closed. \n Opening New Browser to Validate that taxes to be calculate in Singapore Dollars only...");
	...
	Thread.sleep(2000);
		...
		Thread.sleep(2000);
		System.out.println("Validate that 'TAX' in invoice is calculated in Singapore Dollars irrespective of the Product currency for all Accounts.");
