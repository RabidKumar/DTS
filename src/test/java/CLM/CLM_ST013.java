package CLM;
	...
	public class CLM_ST013 {
		...
		public static void main(String[] args) throws IOException, InterruptedException {
			...
			Thread.sleep(2000);
			clm.findElement(By.cssSelector("#leftMenuContainer > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(1) > div:nth-child(7) > div:nth-child(2) > div:nth-child(2)")).click();
			Thread.sleep(2000);

			clm.findElement(By.id("loadOGLDataReschedue")).click();
			clm.findElement(By.cssSelector("button.btn:nth-child(1)")).click();

			Thread.sleep(5000);
			System.out.println("\nPreviously Scheduled GL Extract are Removed.");

			clm.findElement(By.id("frmDate")).sendKeys("0 0 19 5 6 ? *");
			clm.findElement(By.id("postedId")).click();
			clm.findElement(By.cssSelector("button.btn:nth-child(1)")).click();
			
			System.out.println("\nNew GL Posting Scheduled.");
		}
