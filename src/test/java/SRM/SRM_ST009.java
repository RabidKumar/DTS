...
*/
			...
			//srm.findElement(By.cssSelector("")).click();
		    srm.findElement(By.cssSelector("#AdjustmentSummaryComponentDiv > fieldset:nth-child(2) > div:nth-child(2) > div:nth-child(1) > table:nth-child(3) > tbody:nth-child(2) > tr:nth-child(1) > td:nth-child(10) > img:nth-child(1)")).click();
