...
import org.openqa.selenium.os.WindowsUtils;
	...
	public class Sample {
		...
		public static void main(String[] args) throws IOException, InterruptedException {
			...
			Thread.sleep(2000);
			srm.findElement(By.id("account.id")).sendKeys("129250");
			Thread.sleep(2000);
			...
			srm.findElement(By.id("numberReference")).sendKeys("129250");
...
/*			srm.findElement(By.xpath("//div[@id='spanaccountBalanceDetail.id']/span[3]")).click();
			...
			srm.findElement(By.id("actualPaymentAmount")).sendKeys("1.00");
